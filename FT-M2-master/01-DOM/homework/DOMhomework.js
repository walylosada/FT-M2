...
// Tu codigo acá:
let toDoItems = []; // [{description: 'soy una to do', complete: false}, {}]
...
autor.innerHTML = autor.innerHTML + ' Wally!!'; //
...
function buildToDo(todo, index) {
  ...
  return toDoShell; // <div><span>descripcion</span></div>
}
...
function buildToDos(toDos) {
  // [{},{},{}]
  // Tu código acá:
  let result = toDos.map(function (toDo, index) {
...
function displayToDos() {
  // Tu código acá:
  let toDoContainer = document.querySelector('#toDoContainer'); // contenedor de to dos
